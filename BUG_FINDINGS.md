...
**Location:**
`app/src/main/java/com/mauriciotogneri/fileexplorer/data/util/StorageAvailability.kt:25` (the KDoc;
the function is at `:29`)
...
**By severity:** Critical 0 · High 0 · Medium 3 · Low 3
