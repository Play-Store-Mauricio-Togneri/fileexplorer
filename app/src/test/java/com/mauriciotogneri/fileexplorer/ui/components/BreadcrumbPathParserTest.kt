...
class BreadcrumbPathParserTest {
    ...
    fun `parsePath returns empty list for blank path`() {
        val result = BreadcrumbPathParser.parsePath("", internalStorageName, null)
    ...
    fun `parsePath splits path into segments`() {
        val result = BreadcrumbPathParser.parsePath("/foo/bar/baz", internalStorageName, null)
    ...
    fun `parsePath handles path without leading slash`() {
        val result = BreadcrumbPathParser.parsePath("foo/bar", internalStorageName, null)
