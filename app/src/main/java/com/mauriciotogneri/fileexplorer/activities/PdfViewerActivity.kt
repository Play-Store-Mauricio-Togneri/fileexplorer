...
import com.mauriciotogneri.fileexplorer.ui.screens.pdfviewer.PdfViewerScreen
import com.mauriciotogneri.fileexplorer.ui.screens.pdfviewer.PdfViewerViewModel
import com.mauriciotogneri.fileexplorer.ui.theme.FileExplorerTheme
import com.mauriciotogneri.fileexplorer.ui.theme.ThemeManager

/**
 * In-app fallback viewer for PDF files that no installed app could open. Launched by
 * [com.mauriciotogneri.fileexplorer.util.IntentUtil.openFile] via
 * [com.mauriciotogneri.fileexplorer.util.OpenFileResult.RequiresPdfViewer].
 */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            FileExplorerTheme(themeMode = themeMode) {
                val pdfViewerViewModel: PdfViewerViewModel = viewModel(
                    factory = PdfViewerViewModel.Factory(
                        filePath,
                        source,
                        this@PdfViewerActivity.application
                    )
                )
                PdfViewerScreen(
