...
import com.mauriciotogneri.fileexplorer.ui.screens.textviewer.TextViewerScreen
import com.mauriciotogneri.fileexplorer.ui.screens.textviewer.TextViewerViewModel
import com.mauriciotogneri.fileexplorer.ui.theme.FileExplorerTheme
import com.mauriciotogneri.fileexplorer.ui.theme.ThemeManager

/**
 * In-app fallback viewer for text files that no installed app could open. Launched by
 * [com.mauriciotogneri.fileexplorer.util.IntentUtil.openFile] via
 * [com.mauriciotogneri.fileexplorer.util.OpenFileResult.RequiresTextViewer].
 */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            FileExplorerTheme(themeMode = themeMode) {
                val textViewerViewModel: TextViewerViewModel = viewModel(
                    factory = TextViewerViewModel.Factory(
                        filePath,
                        source,
                        this@TextViewerActivity.application
                    )
                )
                TextViewerScreen(
